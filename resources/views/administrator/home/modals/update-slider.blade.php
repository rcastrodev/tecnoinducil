<div class="modal fade" id="modal-update-element">
    <form action="{{ route('home.content.generic-section.update') }}" method="post" id="form-update-slider" class="modal-dialog" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <input type="text" name="content_2" class="form-control" placeholder="Contenido">
            </div>
