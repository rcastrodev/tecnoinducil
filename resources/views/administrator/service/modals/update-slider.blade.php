<div class="modal fade" id="modal-update-element">
    <form action="{{ route('service.content.update') }}" method="post" id="form-update-slider" class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <textarea name="content_2" class="form-control" cols="30" rows="4"></textarea>
            </div>
            <div class="form-group">
                <textarea name="content_3" class="form-control" cols="30" rows="4"></textarea>
            </div>
